...
<div class='page-wrap'>";
                ...
                <header><h1>All Designs</h1>
                    ...
                    function getRandomImage($conn, $tableName)
                    {
                    ...
                    for($i=1;$i<=50;$i++)
                    {
                    getRandomImage($conn,"arabic_images");
                    getRandomImage($conn,"western_images");
                    getRandomImage($conn,"bridal_images");
                    getRandomImage($conn,"babyshower_images");
                    getRandomImage($conn,"kankupagla_images");
                    }
